...
You can ask GitHub to notify you whenever an update is made to the repository using the watch functionality (top right corner) provided on the https://github.com/ucll-vgo/gomoku-starter[repository's website].
====
