...
.. Only covered squares are interactable
.. Uncovered squares show amount of adjacent bombs
...
* After losing, highlight bombs and pressed bomb
* Different color depending of amount of bombs adjacent
